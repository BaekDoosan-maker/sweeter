...
@app.route('/bestbook')
def home2():
    return render_template('bestbook.html')
@app.route('/bestbook', methods=['GET'])
def listing():
    articles = list(db.bestbook.find({}, {'_id': False}))
    return jsonify({'all_articles':articles})


##------------------베스트셀러추천-------------------------------
## API 역할을 하는 부분
@app.route('/bestbook', methods=['POST'])
def saving():
